...
> **Pluralism** is about who we target: Rust seeks to simultaneously appeal to die-hard C++ programmers and to empower dyed-in-the-wool JS devs, and to reach several other varied audiences. ... And pluralism happens at the level of community and goals, not at the level of the actual design.
...
Like PRs, if you put too much into an RFC, it can make the discussion take longer because people tend to be distracted by the biggest "problem"
