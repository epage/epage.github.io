...
published_date: "2026-04-14 11:50:30 -0500"
...
My team at Futurewei is no more,
making me no longer sponsored full time for undirected Rust development.
Almost 5 years is a good run and I appreciate what my
company has allowed me to do in that time.

I would love to have a position where I can use Rust and Cargo in new and interesting ways,
to see them from other perspectives so we can see how we can further improve them.
So much the better if it was for a forward looking company
that would also want me to work upstream to improve the Rust developer experience.
